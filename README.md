...
This is a program to enable a user to search github for their username

## Getting Started

Install Git Search on your local machine bt cloning this repository:

[Github repo](https://github.com/ArnoldOduma/git-search.git) - https://github.com/ArnoldOduma/git-search.git
...
Clone the repository to your local machine from the **[online repository](https://github.com/ArnoldOduma/git-seearch.git)**
...
Click [here](https://arnoldoduma.github.io/git-search/) to go to the live site.<br>
